---
title: Archives & Historical Writings
description: Classic books, magazines, and developer writings from and about the history of MU*s.
---

Links to various sources from the '80s, '90s, and early 2000s, as well as more recent works that cover the history of those days.
...
- [Life on the Screen: Identity in the Age of the Internet](https://archive.org/details/lifeonscreeniden00turk) by Sherry Turkle (1995) - MIT sociologist's landmark study of online identity, built substantially on MUD and MOO fieldwork; borrowable scan on the Internet Archive
...
- [My Tiny Life: Crime and Passion in a Virtual World](https://archive.org/details/mytinylifecrimep0000dibb) by Julian Dibbell (1998) - Book-length account of life in LambdaMOO, expanding "A Rape in Cyberspace"; borrowable scan on the Internet Archive
...
- [Early MUD History](https://mud.co.uk/richard/mudhist.htm) by Richard Bartle - First-hand account of MUD's origins at the University of Essex
...
- [The Game Archaeologist: How DikuMUD Shaped Modern MMOs](https://www.engadget.com/2015-01-03-the-game-archaeologist-how-dikumud-shaped-modern-mmos.html) (Engadget, 2015) - How the Diku lineage defined the mechanics most graphical MMOs still run on
- [Meet the Man Who Invented Microtransactions](https://www.pcgamesn.com/first-game-with-microtransactions) (PCGamesN) - Matt Mihaly on Achaea and selling virtual goods in a text MUD years before the wider industry
- [MUD](https://thedoteaters.com/?bitstory=computer%2Fmud) (The Dot Eaters) - Short illustrated history of MUD1 and its descendants, part of a larger video-game history site
- [ROBLOX is a MUD: The History of Virtual Worlds, MUDs & MMORPGs](https://crpgbook.wordpress.com/articles/roblox-is-a-mud-the-history-of-virtual-worlds-muds-mmorpgs/) by Felipe Pepe - Long, heavily illustrated, well-referenced history from PLATO and MUD1 to modern platforms; one of the best single overviews available
...
- [Interview with Julian Dibbell: The Laws & Governance of Virtual Spaces](https://fieldnotesfromthemetaverse.com/2024/04/26/interview-with-julian-dibbell-the-laws-governance-of-virtual-spaces/) (Field Notes from the Metaverse, 2024) - Dibbell revisits LambdaMOO governance three decades on
- [Interview with Raph Koster: The Declaration of Rights of Avatars](https://fieldnotesfromthemetaverse.com/2024/02/21/interview-with-raph-koster-the-declaration-of-rights-of-avatars/) (Field Notes from the Metaverse, 2024) - Koster on MUD-Dev and the rights of virtual-world inhabitants
- [Matt Chat 296: Richard Bartle on MUDs and British Snobbery](https://www.youtube.com/watch?v=F_7_EMjjysA) - Long-form video interview on MUD1's creation and early MUD culture
- [MUD: Messrs Bartle and Trubshaw's Astonishing Contrivance](https://www.youtube.com/watch?v=YfX8Z8W9JCE) (GDC 2010) - Bartle's own conference talk correcting common myths about MUD's design
- [Raph Koster: The Nature of Gaming](https://www.raphkoster.com/games/interviews-and-panels/raph-koster-the-nature-of-gaming/) (Getting2Alpha) - Podcast conversation reaching back to Koster's start as a MUD designer
- [Raph Koster Recounts a History of Virtual Worlds](https://www.gamedeveloper.com/design/video-raph-koster-recounts-a-history-of-virtual-worlds-from-muds-to-mmos) (GDC) - Keynote segment tracing the line from MUDs through Ultima Online to modern worlds
- [Richard Bartle, Part 1: MUD](https://videogamenewsroomtimemachine.libsyn.com/richard-bartle-part-1-mud-multi-user-dungeon) (Video Game Newsroom Time Machine, 2025) - Bartle guest episode on a general games-history podcast (also on [YouTube](https://www.youtube.com/watch?v=_NxfgBGGWGY))
- [Richard Bartle: What is MUD?](https://www.youtube.com/watch?v=XDtHGelQ0XE) (Octalysis Prime) - Interview on MUD's origins, with a [second part](https://www.youtube.com/watch?v=fMwK6FFZldM) on what came after
...
- [MUD-Dev mailing list archive](https://mud-dev.zer7.com/) - Threaded archive (1996-2010) of developer discussions on design, programming, and roleplay mechanics; a [downloadable archive](https://archive.org/details/mud-archive) of 31,000+ messages is on the Internet Archive
...
- [Shades MUD companion site](http://shades.thestrongs.org) - Fan-run archive and companion site for Shades, one of Britain's first commercial online games, still running since 1984
