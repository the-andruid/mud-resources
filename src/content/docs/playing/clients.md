...
Clients you can download to your computer:
...
| [ZMud](https://www.zuggsoft.com/zmud/zmudinfo.htm) | Win | Older client, no longer supported |

## Browser-based

Clients you can use from your browser:
...
Clients that can be used on your smartphone:
...
Available on GitHub in various forms (not recommended for beginners):
...
Clients that are no longer maintained, distributed, or available. Listed here for historical reference:
