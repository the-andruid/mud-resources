...
description: Directories, crawlers, and server stats for finding MU* to play - or for getting your own game listed.
---

Game directories and server stats that can help you find a multi-user (MU*) game to play based on your preferences.
...
Directories that are no longer maintained, accessible, or updated. Listed here for historical reference:

- MudBytes - Site unavailable
- [Top MUD Sites](https://www.topmudsites.com/) - Now an archive, no longer accepting new listings
