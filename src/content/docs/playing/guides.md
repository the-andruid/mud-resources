...
description: Beginner guides, roleplay primers, and links to communities where you can ask questions about MU*s.
---

Useful guides and links for getting started with multi-user (MU*) games.
...
- [Text-based gaming glossary](https://writing-games.org/text-game-terms/)
